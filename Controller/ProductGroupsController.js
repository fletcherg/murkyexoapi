...
var routes = function () {
    ...
    router.route('/')
        .get(function (req, res) {
             ...
             var sqlQuery = `
SELECT g.[GROUPNO] as GroupId
      ,g.[GROUPNAME] as GroupName
      ,g.[GROUP2_SEQNO] as GroupCategoryId
      ,g.[SALES_GL_CODE] as Sales_GL_Code
      ,g.[PURCH_GL_CODE] as Purch_GL_Code
      ,g.[COS_GL_CODE] as Cos_GL_Code
      ,g.[ISACTIVE] as IsActive
  FROM [dbo].[STOCK_GROUPS] g
ORDER BY g.groupno`;
